...
This is the version created in this session with full time-based presets and batch generation.
"""
...
class MusicGenDirectML:
    def __init__(
        ...
        # Device selection
        self.use_directml = use_directml and torch_directml.is_available()

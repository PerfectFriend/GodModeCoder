#!/usr/bin/env python3
"""
MusicGen DirectML/CPU Client for Radio ArmsgeddonFM
Local music generation on AMD 780M via CPU (DirectML has operator gaps)
"""
...
class MusicGenDirectML:
    def __init__(
        ...
        use_directml: bool = False,  # CPU is stable; DirectML has operator gaps
        ...
        # Force CPU - DirectML has gaps (aten::clone not implemented for AutocastPrivateUse1)
        self.device = torch.device("cpu")
        logger.info("Using CPU device (DirectML has operator support gaps)")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="MusicGen CPU CLI")

...
Runs evolution cycles with tests, debugging, and USB backups
"""
...
class EvolutionRunner:
    ...
    def run_tests(self) -> Dict[str, Any]:
        ...
        try:
            from scripts.musicgen_cpu_client import MusicGenDirectML
        ...
        try:
            from scripts.dj_pipeline import DJPipeline
            results["passed"] += 1
    ...
    def create_backup(self, cycle: int, badge: str) -> Path:
        ...
        backup_items = [
            "scripts/musicgen_cpu_client.py",
            "scripts/audio_stitcher.py",
            "scripts/dj_pipeline.py",
            "scripts/evolution_runner.py",

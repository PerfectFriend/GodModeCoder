#!/usr/bin/env python3
# Wrapper for evolution_engine.py (godmode-coder) that calculates cycle number automatically
...
def main():
    ...
    print(f"[evolution_godmode_coder_cron] Cycle: {cycle}", file=sys.stderr)

    args = sys.argv[1:]

    cmd = [sys.executable, "evolution_engine.py", "--project", "godmode-coder", "--cycle-id", str(cycle)] + args

#!/usr/bin/env python3
# Wrapper for evolution_engine.py (superguard) that calculates cycle number automatically
...
def main():
    ...
    print(f"[evolution_superguard_cron] Cycle: {cycle}", file=sys.stderr)

    # Pass through any additional arguments
    args = sys.argv[1:]

    # Run the main script with --cycle-id
    cmd = [sys.executable, "evolution_engine.py", "--project", "superguard", "--cycle-id", str(cycle)] + args

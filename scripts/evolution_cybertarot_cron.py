#!/usr/bin/env python3
# Wrapper for evolution_engine.py (cybertarot) that calculates cycle number automatically
...
def main():
    ...
    print(f"[evolution_cybertarot_cron] Cycle: {cycle}", file=sys.stderr)

    args = sys.argv[1:]

    cmd = [sys.executable, "evolution_engine.py", "--project", "cybertarot", "--cycle-id", str(cycle)] + args

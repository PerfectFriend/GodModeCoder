#!/usr/bin/env python3
# Wrapper for cycle_start.py that calculates cycle number automatically
...
def main():
    ...
    print(f"[cycle_start_cron] Cycle: {cycle}", file=sys.stderr)

    # Pass through any additional arguments
    args = sys.argv[1:]

    # Run the main script with --cycle
    cmd = [sys.executable, "cycle_start.py", "--cycle", str(cycle)] + args
